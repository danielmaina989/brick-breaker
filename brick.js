...
let blockHeight = 10;
let blockColumns = 8;
let blockRows = 3; //add more as a ame goes on
...
function update() {
  ...
  if (ball.y <= 0) {
    ...
    context.fillText("Game Over: 'Press' to Restart" ,80, 400);
    gameOver = true;
  }
...
function bottomCollision(ball, block) {
  //a is below b(bal is below block)
...
function rightCollision(ball, block) {
  //a is right of b (ball is left of block)
